...
class LoginBlock(tk.Frame):
    ...
    def open_page_after_delay(self):
        time.sleep(2)
        subprocess.Popen([r"C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe", r"localhost\DDHDAS\public\main\main.php"])
        os._exit(0)  # 关闭程序
...
class App(tk.Tk):
    ...
    def create_widgets(self):
        self.background = Background(self, r"C:\wamp64\www\DDHDAS\public\login\bg.png")
